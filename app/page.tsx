...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center flex-col">
      ...
      <div onClick={() => setshowPoetry(!showPoetry)} className="">
        <div className="relative cursor-pointer focus:outline-none inline-flex group mt-10">
          ...
          <div className="relative font-bold focus:outline-none hover:outline-none  inline-flex items-center justify-center px-8 py-3 text-white transition-all duration-200 bg-gray-900 font-pj rounded-full ">
